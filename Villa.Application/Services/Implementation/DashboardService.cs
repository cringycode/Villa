...
public class DashboardService : IDashboardService
{
    ...
    public async Task<RadialBarChartDto> GetTotalBookingChartData()
    {
        ...
        var countByCurrentMonth = totalBookings
            .Count(u => u.BookingDate >= currentMonthStartDate && u.BookingDate <= DateTime.Now);

        var countByPreviousMonth = totalBookings
            .Count(u => u.BookingDate >= previousMonthStartDate && u.BookingDate <= currentMonthStartDate);

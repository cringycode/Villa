...
namespace Villa.Infrastructure.Migrations
{
    ...
    [Migration("20240312110103_addBookingToDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Villa.Domain.Entities.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Villa.Domain.Entities.Booking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Villa.Domain.Entities.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Villa.Domain.Entities.Booking", b =>
                {
                    b.HasOne("Villa.Domain.Entities.AppUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
